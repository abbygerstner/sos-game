...
public class StartGameTest {
    ...
    @BeforeEach
    void setUp() {
        console = new org.sosgame.sprint2.Console(new Board(8)); // start with default 8x8
    }

    /** AC 3.1: Valid new game (no game in progress) **/
    @Test
    void testValidNewGameWithoutGameInProgress() {
        console.startNewGame(5, org.sosgame.sprint2.Console.GameMode.SIMPLE);

        assertEquals(5, console.getBoard().getSize(), "Board should reset to the new chosen size");
        assertEquals(org.sosgame.sprint2.Console.GameMode.SIMPLE, console.getGameMode(), "Game mode should be set to SIMPLE");
    ...
    void testValidNewGameWithGameInProgress() {
        ...
        console.startNewGame(6, org.sosgame.sprint2.Console.GameMode.SIMPLE);
        assertTrue(console.isGameInProgress());

        // Start another game with new settings
        console.startNewGame(9, org.sosgame.sprint2.Console.GameMode.GENERAL);

        assertEquals(9, console.getBoard().getSize(), "Board should reset to new size even if a game was in progress");
        assertEquals(org.sosgame.sprint2.Console.GameMode.GENERAL, console.getGameMode(), "Game mode should update to GENERAL");
    ...
    void testDefaultGameModeWhenNoneSelected() {
        ...
        assertEquals(org.sosgame.sprint2.Console.GameMode.SIMPLE, console.getGameMode(),
    ...
    void testDefaultBoardSizeWhenAppOpens() {
        console.startNewGame(8, org.sosgame.sprint2.Console.GameMode.GENERAL);
