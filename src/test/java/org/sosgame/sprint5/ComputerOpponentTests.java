...
import org.sosgame.sprint4.ComputerPlayer;
import org.sosgame.sprint4.HumanPlayer;
import org.sosgame.sprint4.SOSGame;
import org.sosgame.sprint4.SimpleSOSGame;
...
public class ComputerOpponentTests {
    ...
    void testBluePlayerIsComputerWhenSelected() {
        org.sosgame.sprint4.SOSGame game = new org.sosgame.sprint4.SimpleSOSGame(8, true, false); // blue=CPU, red=human
        assertInstanceOf(org.sosgame.sprint4.ComputerPlayer.class, game.bluePlayer, "Blue player should be a computer");
        assertInstanceOf(org.sosgame.sprint4.HumanPlayer.class, game.redPlayer, "Red player should be a human");
    }

    @Test
    void testRedPlayerIsComputerWhenSelected() {
        org.sosgame.sprint4.SOSGame game = new org.sosgame.sprint4.SimpleSOSGame(8, false, true); // blue=human, red=CPU
        assertInstanceOf(HumanPlayer.class, game.bluePlayer);
        assertInstanceOf(org.sosgame.sprint4.ComputerPlayer.class, game.redPlayer);
    }

    @Test
    void testBothPlayersCanBeComputer() {
        org.sosgame.sprint4.SOSGame game = new org.sosgame.sprint4.SimpleSOSGame(8, true, true);
        assertInstanceOf(org.sosgame.sprint4.ComputerPlayer.class, game.bluePlayer);
    ...
    void testComputerMakesValidMove() {
        org.sosgame.sprint4.SOSGame game = new org.sosgame.sprint4.SimpleSOSGame(5, true, false); // blue = computer
        // Computer or blue goes first automatically
        org.sosgame.sprint4.SOSGame.Move move = game.getComputerMove();
    ...
    void testComputerTurnTriggersAutomaticMove() {
        org.sosgame.sprint4.SOSGame game = new org.sosgame.sprint4.SimpleSOSGame(5, false, true); // blue = human, red = computer
        ...
        org.sosgame.sprint4.SOSGame.Move cpuMove = game.getComputerMove();
    ...
    void testComputerMoveIsOnEmptyCell() {
        org.sosgame.sprint4.SOSGame game = new SimpleSOSGame(5, true, false);
