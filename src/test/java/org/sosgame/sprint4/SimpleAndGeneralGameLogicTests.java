...
import org.sosgame.sprint3.Console;
import org.sosgame.sprint3.GeneralSOSGame;
import org.sosgame.sprint3.SOSGame;
...
public class SimpleAndGeneralGameLogicTests {
    private org.sosgame.sprint3.Console console;

    @BeforeEach
    void setUp() {
        console = new org.sosgame.sprint3.Console();
    }
    ...
    void testFormSOS_SimpleGame_RedWinsImmediately() {
        console.initiateGame(3, org.sosgame.sprint3.Console.GameMode.SIMPLE);
    ...
    void testFormSOS_GeneralGame_ScoringAndContinuedPlay() {
        console.initiateGame(3, org.sosgame.sprint3.Console.GameMode.GENERAL);
        ...
        assertTrue(game instanceof org.sosgame.sprint3.GeneralSOSGame, "Expected GeneralSOSGame instance for general mode.");
